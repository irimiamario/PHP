		  ...
		  <div class="row home_info">
				        ...
				        <div class="panel-body">
                            <div class="container recent_product_container">
                              <div class="row recent_img">
                                ...
                                <div class="col-md-4"><img src="images/MonaLisa.png" class="img-thumbnail home_img" alt="Cinque Terre"></div>
                                <div class="col-md-4"><img src="images/Elgreco.Jpeg" class="img-thumbnail home_img" alt="Cinque Terre"></div>
                              </div>
                                <div class="row recent_img_desc">
                                    <div class="col-md-4">Taj Mahal</div>
                                    <div class="col-md-4">Mona Lisa</div>
                                    <div class="col-md-4">The Burial of the Count of Orgaz</div>
                                </div>
                                <div class="row recent_img_desc">
			...
			<div class="col-md-3 my_cart">
				...
				<div class="cart_items">
					<ol>
                        <li><img src="images/Elgreco.jpeg" alt="The Burial" class="my_cart_items"> <span class="my_cart_items_title">The Burial of the Count of Orgaz</span> <span class="my_cart_items_price">Ron 250</span></li>
                    </ol>
				</div>
			</div>	
		  </div>
